  ...
  >
    <div class="md:w-4/6">
      ...
      <div class="flex flex-wrap justify-between">
        <div class="hidden hover:bg-purple-500 hover:bg-amber-400" />
        <div
          ...
          >
            ...
            <label>Stacks:
              <input
                ...
                type="number"
                min="0"
                :max="characters[name].stackBonus.max" 
                :value="characters[name].stackBonus.stacks"
                @input="stacks = $event.target.value"
              >
            </label>
          </div>
        </div>
